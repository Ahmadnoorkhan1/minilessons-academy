...
const ResetPasswordForm: React.FC = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="2xl:mt-8 mt-6 2xl:text-3xl lg:text-2xl text-xl font-bold text-gray-900">
        Create New Password
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-5 xl:mt-7">
        ...
        <Button className="w-full mt-8" size="lg">
          ...
          <span className="text-gray-50">{isPending ? "Resetting..." : "Reset Password"}</span>
        </Button>
      </form>
      <div className="mt-5 2xl:mt-8 text-center text-base text-gray-600">
        Not now? Return{" "}
        <NavLink to="/log-in" className="text-primary">
          Sign In
        </NavLink>
      </div>
    </div>
