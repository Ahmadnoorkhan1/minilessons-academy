      ...
      <div className="min-h-screen bg-background flex items-center overflow-hidden w-full">
        <div className="min-h-screen basis-full flex flex-wrap w-full justify-center overflow-y-auto">
          ...
          >
            ...
            />
            <div className="relative z-10 backdrop-blur bg-white bg-opacity-15 py-14 px-16 2xl:py-[84px] 2xl:pl-[50px] 2xl:pr-[136px] rounded max-w-[640px]">
              <div>
                <Button
                ...
                >
                  <Icon
                    ...
                    className="text-gray-50 h-[78px] w-[78px] -ml-2"
                  />
                </Button>
                ...
                <div className="mt-5 2xl:mt-8 text-gray-100 text-2xl font-medium">
                  Every step forward brings new opportunities. <br />
                  Embrace the growth.
                </div>
              </div>
            </div>
